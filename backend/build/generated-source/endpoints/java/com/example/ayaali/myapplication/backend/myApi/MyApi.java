...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<com.example.ayaali.myapplication.backend.myApi.model.MyBean> {
    ...
    protected GetJoke(java.lang.String name) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.ayaali.myapplication.backend.myApi.model.MyBean.class);
